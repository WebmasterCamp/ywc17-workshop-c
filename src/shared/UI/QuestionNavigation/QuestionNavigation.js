...
export default function QuestionNavigation(props) {
    ...
    for (let i=1; i <= props.numberofQuestion; i++) {
        QuestionStatusList.push(<QuestionStatus key={i} questionNumber={i} status="done" isMarked={true} onClick={props.onChangeQuestion.bind(null, i + 1)} disabled={parseInt(props.currentQuestionNumber) === i} />)
    }
